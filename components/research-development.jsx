        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {stats.map((stat, index) => (
              <div
                key={index}
                className="text-center p-6 bg-white rounded-xl shadow-sm border border-gray-100 hover:shadow-md transition-all duration-300 hover:-translate-y-1"
              >
              ...
              <div className="relative">
                ...
                <div className="absolute left-0 top-0 bottom-12 w-8 flex flex-col justify-between text-xs text-gray-500 z-10">
                  {yAxisLabels.map((label, index) => (
                    <span key={index} className="text-right pr-2 leading-none">
                      {label}
                    </span>
                  ))}
                </div>
